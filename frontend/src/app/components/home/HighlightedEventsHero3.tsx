...
export function HighlightedEventsHero({
  ...
  //   1. Image trapezoid  — right side, clipped into parallelogram via clip-path
  //   2. Stock badge      — top-right corner
  //   3. Left panel       — headline + event info + CTAs + trust + dots
  ...
  return (
    ...
    >
      {/* ── LAYER 1: Image clipped into parallelogram ───────────────────── */}
      {/*   clip-path: top-left corner cut diagonally, rest fills right side  */}
      <div
        style={{
          position: "absolute",
          top: 0,
      ...
      >
        ...
        {/* Current event: name + venue + price */}
        <div>
          <div
            style={{
              ...S,
        ...
        {/* CTAs: primary "Ver entradas" + secondary row */}
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <Link
            to={`/event/${event.slug}`}
            style={{
