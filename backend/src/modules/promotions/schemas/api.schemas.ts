...
const PromotionTypeSchema = z.enum(['SELLER_DISCOUNTED_FEE', 'BUYER_DISCOUNTED_FEE']);
...
export const CreatePromotionRequestSchema = z.object({
  ...
  { message: 'Either userIds or emails must be provided with at least one value' },
);
...
export type UpdatePromotionStatusRequestInput = z.infer<typeof UpdatePromotionStatusRequestSchema>;
